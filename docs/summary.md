# Документация kolyayurev/adminpanel

* [Обзор и возможности](overview.md)

## Начало работы

* [Установка](getting-started/installation.md)
* [Конфигурация](getting-started/configurations.md)
* [Консольные команды](getting-started/commands.md)
* [Обновление](getting-started/upgrading.md)
...
* [Media](core-concepts/media.md)
* [Permissions & Roles](core-concepts/permissions-roles.md)
* [Multilanguage](core-concepts/multilanguage.md)
* [Breadcrumbs](core-concepts/breadcrumbs.md)
* [Icons](core-concepts/icons.md)
* [Element Plus](core-concepts/element-plus.md)
* [Встроенные DataType](core-concepts/built-in-datatypes.md)

## FormFields

* [Справочник полей](formfields/list.md)
...
* [Trouble shooting](others/trouble-shooting.md)

## Для разработчиков пакета

* [Laravel 13 / PHP 8.4 — контекст рефакторинга и тестов](laravel-13-php-84-ai-context.md)
