...
;( function( $, window, document, undefined ) {
    ...
    "use strict";
        ...
        $.extend( Plugin.prototype, {
            init: function() {
                var _this = this;
                this.forceUpdate = !!(this.element.data('alias-forceupdate'));
                this.changeOnTyping = !!(this.element.data('alias-change-on-typing'));
                this.origins = this.element.attr("data-alias-source").split(",");
                ...
                this.origins.forEach(function(item) {
                    ...
                    if(_this.changeOnTyping)
                    _this.inputs[item].on('keyup change', $.proxy(_this.onChange, _this));
                    $(_this.element).siblings('button').on('click', $.proxy(_this.setSlug, _this))
                });
            ...
            onChange: function(ev) {
                ...
                let strTarget = this.element.val();
            ...
            setSlug(){
                this.element.val(this.slug(this.buildStrOrigin()));
            },
            buildStrOrigin: function (){
                let _this = this;
                let strOrigin = [];
                this.origins.forEach(function(item) {
