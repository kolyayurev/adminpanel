...
class Translator implements ArrayAccess, JsonSerializable
{
    ...
    public function __construct(Model $model)
    {
        ...
        $this->model = $model;
        $this->locale = config('adminpanel.multilingual.default', 'ru');
        $attributes = [];
    ...
    public function save()
    {
        ...
        foreach ($attributes as $key => $attribute) {
            if ($attribute['exists']) {
                ...
                $translation = AdminPanel::model('Translation')->where('table_name', $this->model->getTable())
    ...
    public function deleteTranslation($key)
    {
        ...
        AdminPanel::model('Translation')->where('table_name', $this->model->getTable())
            ->where('column_name', $key)
            ->where('foreign_key', $this->model->getKey())
            ->where('locale', $locale)
            ->delete();
