...
trait AdminPanelUser
{
    ...
    {
        return $this->belongsTo(AdminPanel::modelClass('Role'));
    }
    ...
    {
        return $this->belongsToMany(AdminPanel::modelClass('Role'), 'user_role', 'user_id', 'role_id');
    }
    ...
    {
        $role = AdminPanel::model('Role')->where('name', '=', $name)->first();
